...
Sétimo projeto de Front-End fornecido pela instituição Trybe, onde criamos um website com as cotações e transações que efetuamos.


## Aprendizados

Aprendi sobre o Redux, tanto sua configuração, como os reducers e as actions.
...
```bash
  git@github.com:GuilhermeFMP/Trybe-TrybeWallet.git
